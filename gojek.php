...
ulang:
echo "\n";
echo "\e[96m ( SUBCRIBE CHANEL YOUTUBE : JANDA MUDA CHANNEL YA..! $input)        \n";
echo "\e[89m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
// function change(){
        $nama = nama();
        ...
        sleep(10);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"AKUSERIUSMAIN"}');
